    ...
    <div>
      ...
      <div className="max-w-4xl">
        <Paragraph className=" mt-4">
          Hey there, I&apos;m Muhammad Maulana Firdaussyah - I am deeply interested in technology, 
          programming, design, and business, with a vision to create my own creative agency specializing 
